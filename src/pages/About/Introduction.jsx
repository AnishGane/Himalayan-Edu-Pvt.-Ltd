      ...
      <div className="flex flex-col items-start gap-6 space-x-10 sm:gap-0 lg:mt-5 lg:flex-row 2xl:space-x-16">
        ...
        <div className="w-full space-y-6 text-justify 2xl:w-1/2">
          ...
          <p>
            ...
            since its establishment. In 2022, Topa International re-branded in terms of its location
            and office environment with efficient services to students and institutions in Japan
            which reflect our professionalism and dedication to provide reliable information to the
            students and institutions of various countries including Japan.
          </p>
          ...
          <p>
            Since its inception, Topa International have successfully placed 8000+ students to study
            in Japan at various colleges and fulfilling their aspirations of studying abroad. We at
            Topa International make sure that our counselors provide end to end individualized
            guidance and support for each student from the word go. Starting with course selection,
            fee structure, an education program to making applications to the institutions, we
            ensure that every step is meticulously taken care of to perfection.
          </p>
          <p>
