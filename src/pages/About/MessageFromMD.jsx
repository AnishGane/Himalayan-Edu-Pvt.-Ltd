        ...
        <div className="flex flex-col items-start gap-6 space-x-10 sm:gap-0 lg:mt-6 lg:flex-row 2xl:space-x-16">
          ...
          <div className="w-full space-y-4 text-justify text-slate-800">
            ...
            <p>
              ...
              facilitate excellent educational options for the personal growth and career
              fulfillment of students aspiring to study abroad.
            </p>
            <p>
              With more than a decade of experience in the field of overseas education consultancy,
              I have realized that it is one of the most volatile industries in the world and most
            ...
            <p>
              ...
              success of our organization, ever since it was established in 2004, can be attributed
              to our ability to continually identify and respond to the changing demands across the
              ever-expanding international education sector.
            </p>
            <p>
              With a keen focus on quality education, we are steadfast in our path, giving
              assistance and aid to students for attaining meritorious heights. We work closely to
              serve students in fulfilling their academic dreams through a cost-effective package
              and professional guidance. We look forward to answering your queries and ensure
            ...
            <p className="mb-6">
              ...
              as an Instructor since I came back to Nepal in 2006. I personally know the life style
              of cities of Japan and closely observed the education system which encourage me to
              facilitate Nepalese student to study in Japan. The Japanese language is interesting
