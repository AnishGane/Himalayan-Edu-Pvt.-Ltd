...
const ServiceDetail = () => {
  ...
  if (!matchedService) {
    return (
      <div
        className="wrapper relative z-30 mt-10 flex min-h-screen w-full flex-col items-center justify-center rounded-lg bg-gradient-to-br from-gray-50 to-red-50 text-center md:mt-2 md:border md:border-gray-200 md:p-6"
        role="alert"
        aria-live="polite"
      >
    ...
    >
      ...
      >
        ...
        <div className="mb-6 flex flex-col items-center text-center">
          <matchedService.icon
            className="text-main-indigo mb-3 text-5xl md:text-6xl"
            aria-hidden="true"
          />
          <h1 id="service-title" className="text-main-indigo text-3xl font-bold md:text-4xl">
            {matchedService.title}
          </h1>
          <p id="service-description" className="mt-3 max-w-2xl text-gray-600">
        ...
        {/* Divider */}
        <div
          className="bg-main-indigo/80 mx-auto mb-6 h-[2px] w-24 rounded-full"
          aria-hidden="true"
        ></div>
        ...
        <div className="mt-10 flex justify-center">
          <Link aria-label="Back to Services" to="/services">
            <button
              className="bg-cta-red hover:bg-cta-hover flex cursor-pointer items-center gap-1.5 rounded-lg px-8 py-4 font-semibold text-white shadow-md transition-all duration-200 hover:scale-[1.015]"
              aria-label="Back to Services"
            >
              <FaArrowLeft className="size-4" aria-hidden="true" /> Back to Services
            </button>
          </Link>
        </div>
      </motion.div>
